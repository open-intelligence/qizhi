<style>
  ...
  @import "../assets/styles/infor-card.less";
</style>
<template>
  <div class="app-wrapper" :class="{hideSidebar:!state.sidebar.opened,hoverSideBar:state.sidebar.minOpen}">
    ...
    <div class="side-wrapper" :class="{hover:!state.sidebar.minOpened,light:theme=='light'}">
      ...
      <div style="height:50px;" class="logo-box">
        <img :src="require('@/assets/qizhi.png')" alt="" height="50" v-show="state.sidebar.opened">
...
<script>
  import THeader from '@/components/layout/base/THeader'
  ...
  export default {
    ...
    created () {
      this.username =Cookies.getJSON('session').username;
